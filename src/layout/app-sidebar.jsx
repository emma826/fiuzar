    ...
    return (
        <aside className="flex flex-col items-center bg-white text-gray-700 shadow h-full">
            ...
            <div className="mt-auto h-16 flex items-center w-full">
                <button onClick={() => signOut({ callbackUrl: "/" })} className="h-16 w-full mx-auto flex justify-center items-center focus:text-orange-500 hover:bg-red-200 focus:outline-none">
