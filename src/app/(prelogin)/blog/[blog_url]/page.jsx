...
export default async function Blog_urlPage({ params }) {
    ...
    try {
        ...
        blogData = blogs
        blogBody = JSON.parse(blogs.body)
        blogBody = blogBody.blocks
                ...
                <div className="-mx-4 flex flex-wrap justify-center">
                    <div className="w-full px-4 lg:w-8/12">
                        <div>
                            ...
                            <div className="mb-10 flex flex-wrap items-center justify-between border-b border-gray-300 border-opacity-10 pb-1">
                                    ...
                                    <div className="mb-5 mr-10 flex items-center text-black">
                                        ...
                                        <div className="w-full">
                                            <span className="mb-1 text-base font-medium text-body-color">
                                                By <span>Amoke Emmanuel Chinonye</span>
                                            </span>
                                        </div>
                                    </div>
