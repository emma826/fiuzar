    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">Welcome to Fiuzar</h1>
            ...
            <div className="grid gap-6">
                ...
                <div>
                    ...
                    {otp ? (
                        <Button onClick={verifyOtp} className="w-full cursor-pointer" disabled={process.env.NODE_ENV === "production"}>
                            Verify OTP
                        </Button>
                    ) : (
                        <Button onClick={emailSignup} className="w-full cursor-pointer" disabled={process.env.NODE_ENV === "production"}>
                            Get OTP
                        </Button>
                    )}
                </div>
                ...
                {!otp && (
                    <>
                        ...
                        <Button variant="outline" onClick={googleSignIn} className="w-full" disabled={process.env.NODE_ENV === "production"}>
